...
public class WordCount {
    ...
    public void map(Object key, Text value, Context context
      ...
      //projects a key value pair if the word token is any of the four keywords : 'agriculture', 'education', 'politics' or 'sports'
    ...
    private IntWritable result = new IntWritable();
      ...
      //Counting the frequency for each key (state:keyword) emitted from Mapper
